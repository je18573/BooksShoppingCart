...
namespace BooksShoppingCart
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<ApplicationRoleManager>(ApplicationRoleManager.Create); //新增之角色管理器
            ...
            app.UseFacebookAuthentication(
               appId: "1446067532359704",
               appSecret: "ee6871598a0b4069f87299cd1bfc6d4a");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "1073187285063-6s28vb5aejnqnq9bdmleuj6gfotkm9j9.apps.googleusercontent.com",
                ClientSecret = "51r1HlLkmFEEboukODLClzMF"
            });
        }
    }
}